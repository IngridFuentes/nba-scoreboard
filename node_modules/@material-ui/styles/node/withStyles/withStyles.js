...
const withStyles = (stylesOrCreator, options = {}) => Component => {
  ...
  const WithStyles = /*#__PURE__*/React.forwardRef(function WithStyles(props, ref) {
    const {
      innerRef
          ...
          other = (0, _objectWithoutPropertiesLoose2.default)(props, ["classes", "innerRef"]); // The wrapper receives only user supplied props, which could be a subset of
  ...
  process.env.NODE_ENV !== "production" ? WithStyles.propTypes = {
     ...
     * @deprecated
     */
    innerRef: (0, _utils.chainPropTypes)(_propTypes.default.oneOfType([_propTypes.default.func, _propTypes.default.object]), props => {
